...
internal enum Assets {
  ...
  internal enum Icons {
    ...
    internal static let arrowLeft = ImageAsset(name: "Icons/arrowLeft")
    internal static let arrowRight = ImageAsset(name: "Icons/arrowRight")
    internal static let email = ImageAsset(name: "Icons/email")
    internal static let eye = ImageAsset(name: "Icons/eye")
    internal static let lock = ImageAsset(name: "Icons/lock")
    internal static let warning = ImageAsset(name: "Icons/warning")
  }
  internal enum Images {
    internal static let camera = ImageAsset(name: "Images/camera")
    internal static let flower = ImageAsset(name: "Images/flower")
    internal static let frame = ImageAsset(name: "Images/frame")
    internal static let leaves = ImageAsset(name: "Images/leaves")
  }
}
